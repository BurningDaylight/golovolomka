...
public:
	...
	bool can_place_figure(const figure_t& figure, const coord_t coords) const;
	void on_figure_placement(const figure_t& figure, const coord_t coords);
	void on_figure_removal(const figure_t& figure, const coord_t coords);
};
